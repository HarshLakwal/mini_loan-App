            ...
            <div class="flex-grow text-gray-800">
                ...
                <main class="p-6 sm:p-10 min-h-[90vh] space-y-6">
                    <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                        ...
                        <div>
                            <h1 class="text-3xl font-semibold mb-2 ">Laon: {data?.term?.loans[0]?.isPaid  ? <span className='bg-green-300 p-2 rounded'>Paid</span> : <span className='bg-red-300 p-2 rounded'>Unpaid</span>}</h1>
                        </div>
                    </div>
                    {
                        terms &&
